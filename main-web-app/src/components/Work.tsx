...
const projects = [
  {
    num: "01",
    name: "2D Browser Adventure Game",
    category: "Interactive Application",
    tools: "HTML5 Canvas, Vanilla JavaScript, CSS Keyframes, Audio Synthesis",
    image: "/images/game_dev_preview.jpg",
    link: "https://github.com/Zishan3909",
  },
  {
    num: "02",
    name: "LeetCode DSA Journey",
  ...
  {
    num: "03",
    name: "Developer GitHub Portfolio",
